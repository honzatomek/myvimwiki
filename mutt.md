...
save the two respective keys to `*.pem` files for further use.
...
or set up. then `msmtp` needs to be installed, set up and specified.
...
set index_format = "%4C [%Z] %?X?A&-? %D  %-30.30a  %s"
set sort = threads
