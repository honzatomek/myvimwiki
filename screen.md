...
- [statusline](#statusline)
    - [simple](#statusline#simple)
    - [convoluted](#statusline#convoluted)
...
## convoluted
From: https://serverfault.com/questions/3740/what-are-useful-screenrc-settings
```screen
...
```zsh
o here's my zshrc settings to tell screen about what I'm doing in each tab.
